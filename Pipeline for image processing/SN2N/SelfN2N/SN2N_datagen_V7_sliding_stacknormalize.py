# -*- coding: utf-8 -*-
"""
Created on Wed Apr 20 13:34:34 2022
...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 20 12:42:24 2022
...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 16 20:49:40 2022
...
#        image_data = np.array(imread(img_path)).astype('float32')
    ...
    def random_interchange(self, imga, imgb = [], size = (12, 12), mode = 1):
        """
    ...
    # def savedata4folder(self, interval = 64, threshold = 15):
    #     """
    #     Not in use
    #     """
    #     flage = 1
    ...
    #             image_arr = self.slidingWindow(image_data, 
    #                         interval, threshold)
    ...
    def savedata4folder(self, interval = 64, threshold = 15):
        """
        SelfN2N tool: Generator without random interchange 
        ------
        interval
            interval pixel number to slide
            {default: 64}
        ...
        for (root, dirs, files) in os.walk(self.img_path):
            for j, Ufile in enumerate(files):
                img_path = os.path.join(root, Ufile)
                image_data = self.imread_stack(img_path)
                print('For number %d frame'%(j + 1))
                try:
    ...
    def savedata4folder_agument(self, flage = 1, interval = 64, threshold_mode = 2, threshold = 15, 
