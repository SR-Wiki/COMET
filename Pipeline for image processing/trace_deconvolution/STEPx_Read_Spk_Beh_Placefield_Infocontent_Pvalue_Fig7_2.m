...
%##########################################################################
binSize            = 2;        % 2 cm bins for an arena of 45 cm square area
binRad             = 23;
...
%==========================================================================
    ...
    title('Rectangular mask for the shape of open field')
    nbins_cir_2d_2d_pad      = padarray(nbins_cir_2d_2d,[5 5],0,'both');
    figure(501)
    heatmap((nbins_cir_2d_2d_pad));
    title('Rectangular mask for the shape of open field after zeropadding')
%==========================================================================
...
%     set(gcf,'color','w');        
    xlim([-binRad binRad])
    ylim([-binRad binRad])
    xticks(-binRad:1:binRad)
    yticks(-binRad:1:binRad)
