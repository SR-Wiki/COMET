path='H:\CM2scope_experimental_data\social\gzc_rasgrf-ai148d-371\My_V4_Miniscope\';
...
cn_images=imread([path,'AMF_MC_denoised_8bit_correlation_images_sigma2.png']);
...
save([path,'AMF_MC_denoised_8bit_caiman_result_handcured.mat'], 'A_neuron_bad_idx', 'A_neuron_good_idx', 'A_neuron_sparse', 'coordinates', 'C_trace', 'C_raw','detrended_trace','-v6');
