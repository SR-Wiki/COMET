...
win32 {
    ...
    LIBS += -LC:/opencv-4.4.0/opencv/build/lib -llibopencv_world440

#    LIBS += -LC:/opencv-4.4.0/build/lib/Debug -lopencv_world440d

    # Path to openCV header files
    INCLUDEPATH += C:/opencv-4.4.0/opencv/build/install/include
...
#    LIBS += -LC:/Python38/libs -lpython38
    ...
    INCLUDEPATH += C:/Users/PKU/.conda/envs/physicnetLFM/include
    LIBS += -LC:/Users/PKU/.conda/envs/physicnetLFM/libs -lpython37

    # For numpy
    INCLUDEPATH += C:/Users/PKU/.conda/envs/physicnetLFM/Lib/site-packages/numpy/core/include
