...
win32 {
    ...
    #LIBS += D:/opencv-4.4.0/qt_build/lib/libopencv_*.a

    LIBS += -LD:/opencv-4.4.0/qt_build/lib -lopencv_world440

    # Path to openCV header files
    INCLUDEPATH += D:/opencv-4.4.0/qt_build/install/include
...
#    LIBS += -LC:/Python38/libs -lpython38
    ...
    INCLUDEPATH += "D:\\Program Files\\Python39\\include"
    LIBS += -L"D:\\Program Files\\Python39\\libs" -lpython39

    # For numpy
    INCLUDEPATH += "D:/Program Files/Python39/Lib/site-packages/numpy/core/include"
